bl_info = {
    ...
    "description": "Batch import models, join meshes, check poly count, decimate, and export.",
...
class BATCHDECIMATOR_OT_decimate(Operator):
    ...
    def execute(self, context):
        ...
        for f in files:
            ...
            # --- NEW: JOIN ALL MESH OBJECTS BEFORE DECIMATION ---
            if len(mesh_objects) > 1:
                ...
                print(f"🔗 Joined meshes into '{mesh_objects[0].name}' ({len(mesh_objects[0].data.polygons)} polys)")
